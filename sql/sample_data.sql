...
INSERT INTO `favorites` (`crd`, `user_id`, `post_id`) VALUES
	('2015-11-22 13:46:05', 1, 1);
/*!40000 ALTER TABLE `favorites` ENABLE KEYS */;

-- Dumping data for table homebooru.image: ~9 rows (approximately)
DELETE FROM `image`;
...
INSERT INTO `image` (`id`, `crd`, `lmd`, `status`, `type`, `post_id`, `filename`, `md5`, `sha1`, `sha256`, `width`, `height`, `size`) VALUES
	...
	(10, '2015-12-06 11:22:32', '2015-12-06 11:09:07', 0, 1, 3, 'file3.jpg', '0c0d03edf4e145ffd75eafb6d73deaa7', '9414b608df81fbc2563f467df918ca652c899953', '8030404398e6639ff1395dd8e38c782bf6c9e00229adfc54408c967a2e981b51', 20, 20, 1500),
	(11, '2015-12-06 11:22:32', '2015-12-06 11:09:07', 0, 2, 3, 'file3_sm.jpg', '0c0d03edf4e145ffd75eafb6d73deaa7', '9414b608df81fbc2563f467df918ca652c899953', '8030404398e6639ff1395dd8e38c782bf6c9e00229adfc54408c967a2e981b51', 20, 20, 1500),
	(12, '2015-12-06 11:22:32', '2015-12-06 11:09:07', 0, 3, 3, 'file3_th.jpg', '0c0d03edf4e145ffd75eafb6d73deaa7', '9414b608df81fbc2563f467df918ca652c899953', '8030404398e6639ff1395dd8e38c782bf6c9e00229adfc54408c967a2e981b51', 20, 20, 1500);
/*!40000 ALTER TABLE `image` ENABLE KEYS */;

-- Dumping data for table homebooru.post: ~3 rows (approximately)
DELETE FROM `post`;
...
INSERT INTO `post` (`id`, `crd`, `lmd`, `status`, `rating`, `source`, `submitter`, `md5`, `sha1`, `sha256`) VALUES
	...
	(3, '2015-12-06 11:21:53', '2015-12-06 11:09:33', 5, 3, NULL, 1, '0c0d03edf4e145ffd75eafb6d73deaa7', '9414b608df81fbc2563f467df918ca652c899953', '8030404398e6639ff1395dd8e38c782bf6c9e00229adfc54408c967a2e981b51');
...
INSERT INTO `post_tag` (`crd`, `post_id`, `tag_id`) VALUES
	('2015-12-06 11:19:39', 1, 1),
	('2015-12-06 11:19:39', 1, 3),
	('2015-12-06 11:19:39', 1, 5),
	('2016-01-01 10:30:41', 1, 6),
	('2015-12-06 11:19:39', 1, 8),
	('2015-12-06 11:19:39', 2, 1),
	('2015-12-06 11:19:39', 2, 2);
...
INSERT INTO `user` (`id`, `crd`, `lmd`, `type`, `username`, `email`, `active`, `akey`, `rkey`, `options`, `karma`, `submissions`) VALUES
	(1, '2015-11-22 13:34:14', '2016-01-02 06:56:57', 0, 'Anonymous', 'sha256:c8b5f366611ec7780982fdff810fb3aa6316fcfda775dba22bc8216ca7c89e2f', '2015-11-22 13:34:14', NULL, NULL, NULL, 0, 3);
